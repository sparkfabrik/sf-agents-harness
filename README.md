...
| **create-gitlab-issue**    | Create grounded GitLab issues -- audits project state, resolves labels and attribution at runtime, defers to `glab`                                           | `skills/system/create-gitlab-issue/`    |
...
| **security-assessment**    | Orchestrate VA (static scanning, Docker scans, manual review) + PT (live recon/exploitation) tracks and merge both into one standalone HTML report            | `skills/system/security-assessment/`    |
...
| **sf-writing-style**       | Canonical SparkFabrik writing style -- aired markdown, bold lead-in lists, em/en-dash ban, slop blacklist                                                     | `skills/system/sf-writing-style/`       |
