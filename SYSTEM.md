...
- **code-security-audit** -- Multi-phase code security audit workflow for web applications and APIs, including malicious npm, PyPI, and Packagist dependency and supply-chain incident triage. Open-source tools only.
