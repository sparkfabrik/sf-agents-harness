...
- Upstream skill sync: temporarily run every five minutes on an offset cadence and seed a generated-skill marker to validate the scheduled auto-merge path.
