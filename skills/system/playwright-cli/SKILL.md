...
name: playwright-cli
description: >-
  Browser automation with the playwright-cli tool. Use when the user needs to 
  automate browser interactions, test web apps, take screenshots, fill forms, 
  or extract data from pages. Trigger on: "playwright-cli", "playwright", 
  "browser automation", "headless browser", "web scraping", "screenshot", 
